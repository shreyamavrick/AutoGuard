      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
            At Auto Guard, we ensure that our customers can focus on their core business operations without worrying about vehicle maintenance.
          </p>
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed mt-4">
            We provide Annual Maintenance Contracts (AMCs) for all types of vehicles, including Hatchbacks, Sedans, Mini SUVs, and SUVs, delivering reliable performance and complete peace of mind.
          </p>
        </div>
      </div>
    </section>
