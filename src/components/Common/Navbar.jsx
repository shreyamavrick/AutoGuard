      ...
      <div className="w-full px-4 sm:px-8">
        <div className="flex items-center py-2 md:py-2.5 min-h-[70px]">
          ...
          <div className="flex items-center gap-2">
            <Link to="/" className="flex-shrink-0">
              <img
                src={logo}
                alt="Logo"
                className="h-28 w-auto object-contain sm:h-25"
                draggable={false}
              />
            </Link>
            <ul className="hidden lg:flex items-center space-x-2">
              {navWithIcons.map((item, i) => (
                <li key={item.label} className="flex items-center">
                  {i > 0 && (
                    <span className="text-[#9D00FF] text-xl font-bold mx-1 pb-1">
                      •
                    </span>
                  )}
                  <Link
          ...
          <div className="hidden lg:flex items-center gap-4">
            <div className="flex items-center gap-2">
              <span className="w-11 h-11 flex items-center justify-center rounded-full bg-[#9D00FF]">
              ...
              <div>
                ...
                <a
                  href="tel:7217747633"
                  className="block font-extrabold text-base text-[#9D00FF] tracking-wide hover:underline"
                >
                  +(91)XXXXXXXXXX
                </a>
              </div>
            ...
            {user ? (
              ...
              <Link
                to="/login"
                className="group relative flex items-center rounded-full pl-8 pr-14 py-2 border-2 border-[#b859f3] font-semibold text-[#a622f8] text-base transition-all duration-200 hover:bg-[#6a00ab] hover:text-white outline-none"
              >
                Login
                <span className="ml-2 w-8 h-8 bg-white group-hover:bg-[#9D00FF] border-2 border-[#9D00FF] group-hover:border-white rounded-full flex items-center justify-center absolute right-2 top-1/2 -translate-y-1/2 transition-colors">
                  <ArrowUpRight
                    className="text-[#9D00FF] group-hover:text-white transition-colors"
                    size={22}
                  />
                </span>
              </Link>
