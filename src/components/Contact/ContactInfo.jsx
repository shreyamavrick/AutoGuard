...
const contactItems = [
  ...
  },
  {
    ...
    title: "Our Location",
    lines: [
      "Auto Guard India Pvt. Ltd. 1234, Zenith Tower, Sector 9 Metro Road",
      "New Delhi – 110099 India",
    ],
  },
  {
    icon: <Phone size={28} className="text-purple-500" />,
    title: "Call US 24/7",
    lines: ["Phone: +91 XXX-XXX-XXXX", "Mobile: +91 987-654-3210"],
  },
  {
    icon: <CalendarDays size={28} className="text-purple-500" />,
    title: "Working Days",
