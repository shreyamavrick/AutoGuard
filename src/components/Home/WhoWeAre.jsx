...
import Service_img from "../../assets/image-service.webp";
      ...
      <div className="relative z-10 max-w-7xl w-full px-2 sm:px-8 py-12 grid md:grid-cols-2 gap-8">
        ...
        <div className="flex items-center justify-center">
          <div className="w-full bg-black bg-opacity-90 rounded-2xl px-6 py-10 shadow-2xl max-w-xl">
            <p className="text-[#9D00FF] uppercase font-semibold tracking-wide mb-2 text-[15px]">/ Who We Are /</p>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-4 text-white">
              The <span className="text-[#9D00FF]">story</span> behind<br />service workshop
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3">
              {features.map((feature, idx) => (
                <div key={idx} className="flex items-center gap-2">
                  <FaCheckCircle className="text-[#9D00FF] text-base sm:text-lg" />
