    ...
    >
      <div className="flex flex-col lg:flex-row w-full">
        ...
        <div className="w-full lg:w-1/2 bg-black bg-opacity-90 p-10 lg:p-20 text-white flex flex-col justify-center">
          <p className="text-purple-400 uppercase tracking-widest font-medium mb-2">
            / Cost Calculator /
          </p>
          <h2 className="text-3xl sm:text-5xl font-bold mb-10">
            Get your free <span className="text-purple-400">estimate</span>!
          </h2>
          ...
          <form className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-white">
            ...
            <button
              type="submit"
              className="mt-6 bg-purple-500 hover:bg-purple-600 text-white py-3 px-6 rounded-full flex items-center gap-2 sm:col-span-2 justify-center text-lg font-semibold transition"
            >
