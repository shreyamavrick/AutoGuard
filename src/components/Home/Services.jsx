  ...
  return (
    <div className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-6 mb-10">
        <p className="text-purple-500 font-semibold text-sm tracking-wide uppercase">
          / Our Services /
        </p>
        <h2 className="text-4xl sm:text-5xl font-bold leading-tight mt-2">
          We offer a <span className="text-purple-500">wide range</span>
          ...
          {[...services, ...services].map((service, index) => (
            ...
            >
              ...
              <a
                ...
                className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-purple-500 text-white hover:bg-purple-600 transition"
              >
                <FaArrowRight />
              </a>
            </div>
