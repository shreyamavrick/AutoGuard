...
return (
  <div className="min-h-screen bg-gradient-to-tr from-indigo-50 to-purple-100 flex items-center justify-center px-2">
    <div className="w-full max-w-md bg-white shadow-xl rounded-2xl overflow-hidden my-12">
      <div className="flex flex-col items-center px-8 pt-8">
        <div className="bg-purple-500 text-white text-3xl w-20 h-20 flex items-center justify-center rounded-full border-4 border-white shadow mb-4">
