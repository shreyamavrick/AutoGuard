    ...
    <section className="py-14 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <header className="mb-10">
          ...
          {targetServiceParam && (
            <div className="mt-4 rounded-xl border border-purple-200 bg-purple-50 px-4 py-3 text-purple-800">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {plans.map((plan) => {
            ...
            return (
              <div key={plan._id} className={`relative flex flex-col rounded-2xl border bg-white shadow-sm hover:shadow-md transition ${recommendedPlanId === plan._id ? "ring-2 ring-purple-500" : "border-gray-200"}`}>
                    ...
                    <div className="flex gap-3">
                      {["oneTimePrice", "monthlyPrice"].map((type) => (
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg border ${selectedType === type ? "bg-purple-600 text-white border-purple-600" : "border-gray-300 text-gray-700"}`}
                        >
                ...
                <div className="p-6 border-t">
                  <button onClick={() => handleSubscribe(plan)} className="w-full rounded-xl bg-purple-600 hover:bg-purple-700 text-white py-2 font-semibold transition">
